...
\begin{itemize}
  ...
  \item \textbf{Images}: Si $q_S d\in\mathcal{L}^2(\Omega,\mathbb{R})$, l'action est la composition avec l'inverse (pour préserver l'intensité): $\varphi\cdot q_S:=q_S\circ\varphi^{-1}$.
\end{itemize}
...
Pour garantir l'existence et l'unicité des trajectoires sur l'espace de forme, revenons au cas général avec le théorème suivant.
